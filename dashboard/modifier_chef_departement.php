                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Tableaux de données de chef département</h6>
                                ...
                                <div class="card-body" style="color:black">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive w-100">
                                        ...
                                        <tbody class="w-100">
                                            <?php $result = custom_select_chef_departement();
                                            ...
                                            if ($result) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo '<td>' . $row["date"] . '</td>';
                                                    echo '<td class="text-center"> <i  class="fa fa-edit " onclick="showEdit(' . $row["id_chef_departement"] . ')" style="color:#009de8;cursor:pointer;font-size: 16px;"></i><i class="fa fa-trash" onclick="showRemove(' . $row["id_chef_departement"] . ')" style="margin-left:15px;color:red;cursor:pointer;font-size: 16px;"></i></td>';
                                                    echo "</tr>";
                                                }
                                            }
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="ecoleModelLabel">Éditer Chef Département</h5>
                                    ...
                                    <div class="modal fade" id="removeModel" tabindex="-1" aria-labelledby="removeModel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="removeModel">Supprimer chef de Département</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    ...
                                                    <div>
                                                        <div class="alert alert-danger text-center" role="alert">
                                                            <h1>Voulez-vous supprimer définitivement cette chef de Département?</h1>
                                                        </div>
    ...
    <script>
        function showEdit(id) {
            ...
            $(document).ready(function() {
                $.ajax({
                    url: "db/_modifier_chef_departement.php",
                    type: "GET",
                    data: {
                        editChefDepartementID: id,
                    },

                    success: function(result) {

                        if (result != '') {
                            $('#editChefDepartement').html(result);
                            $('#editModel').modal('show');
                            $('#id_chef_departement').val(id);
                            $('#saveEdit').attr('data-id', id)

                        } else if (dataResult.statusCode == 201) {
                            $('#resultEdit').html('<div class="alert alert-danger" id="denger-alert" role="alert">Le chef de departement n\'a pas été modifier avec succès </div>');
        ...
        $(document).ready(function() {
            ...
            $('#saveEdit').click(function() {
                ...
                var id_chef_departement = $('#saveEdit').data('id');
                var ecole = $('#inputGroupSelect2').find(":selected").val();
                var departement = $('#inputGroupSelect3').find(":selected").val();
                ...
                if (ecole != '' && departement != '') {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        data: {
                            id_chef_departement: id_chef_departement,
                        ...
                        success: function(result) {
                            ...
                            if (dataResult.statusCode == 200) {
                                ...
                                $('#resultEdit').html('<div class="alert alert-danger" id="denger-alert" role="alert">Le chef de departement  n\'a pas été modifie avec succès </div>');
                                $("#denger-alert").fadeTo(2000, 500).slideUp(500, function() {
                                    $("#denger-alert").slideUp(500);
                                });
                            }
            ...
            $('#remove').click(function() {
                $.ajax({
                    ...
                    type: "GET",
                    data: {
                        removeChefDepartementID: $(this).data('id'),
                    },
                    success: function(result) {
                        if (result = 1) {
                            location.reload(true);
