                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body" style="color:black">
                                    ...
                                    <form method="post">
                                        <label for="inputGroupSelect">Choisissez le nom de l'école<span style="color:red">*</span></label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#submit').click(function() {
                ...
                var ecole = $('#inputGroupSelect').find(":selected").val();
                ...
                if (nom != '' && ecole != '') {
                    ...
                    $.ajax({
                        url: "db/_ajouter_departement.php",
                        type: "POST",
                        data: {
                            nom: nom,
                            ecole: ecole,
                        ...
                        success: function(result) {
                            ...
                            if (dataResult.statusCode == 200) {
                                $('input[name="nom"]').val('');
                                $('#result').html('<div class="alert alert-success" id="success-alert" role="alert">Le Département a été ajoutée avec succès </div>');
                                $("#success-alert").fadeTo(2000, 500).slideUp(500, function() {
                                    $("#success-alert").slideUp(500);
                                });

                            } else if (dataResult.statusCode == 201) {
                                $('#result').html('<div class="alert alert-danger" id="denger-alert" role="alert">Le Département n\'a pas été ajoutée avec succès </div>');
