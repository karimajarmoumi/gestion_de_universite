    ...
    <script>
        $(document).ready(function() {
            ...
            $('#submit').click(function() {
                ...
                if (user != '' && ecole != '' && departement != '' && filiere != '') {

                    $.ajax({
                        url: "db/_ajouter_professeur.php",
                        type: "POST",
                        data: {
                            user: user,
                            filiere: filiere,
                        ...
                        success: function(result) {
                            ...
                            if (dataResult.statusCode == 200) {
                                $("#inputGroupSelect4").val($("#inputGroupSelect4 option:first").val());

                                $('#result').html('<div class="alert alert-success" id="success-alert" role="alert">Le professeur a été ajoutée avec succès </div>');
                                $("#success-alert").fadeTo(2000, 500).slideUp(500, function() {
                                    $("#success-alert").slideUp(500);
                                });

                            } else if (dataResult.statusCode == 201) {
                                $('#result').html('<div class="alert alert-danger" id="denger-alert" role="alert">Le professeur n\'a pas été ajoutée avec succès </div>');
