                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Tableaux de données des filières</h6>
                                ...
                                <div class="card-body" style="color:black">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive w-100">
                                        ...
                                        <tbody class="w-100">
                                            <?php $result = custom_select_filiere();
                                            ...
                                            if ($result) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo '<td>' . $row["date"] . '</td>';
                                                    echo '<td class="text-center"> <i  class="fa fa-edit " onclick="showEdit(' . $row["id_filiere"] . ')" style="color:#009de8;cursor:pointer;font-size: 16px;"></i><i class="fa fa-trash" onclick="showRemove(' . $row["id_filiere"] . ')" style="margin-left:15px;color:red;cursor:pointer;font-size: 16px;"></i></td>';
                                                    echo "</tr>";
                                                }
                                            }
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="ecoleModelLabel">Éditer filière</h5>
                                    ...
                                    <div class="modal fade" id="removeModel" tabindex="-1" aria-labelledby="removeModel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="removeModel">Supprimer filière</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    ...
                                                    <div>
                                                        <div class="alert alert-danger text-center" role="alert">
                                                            <h1>Voulez-vous supprimer définitivement cette filière?</h1>
                                                        </div>
    ...
    <script>
            ...
            $(document).ready(function() {
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (result != '') {
                            $('#editFiliere').html(result);
                            $('#editModel').modal('show');
                            $('#id_filiere').val(id);
                            $('#saveEdit').attr('data-id', id)

                        } else if (dataResult.statusCode == 201) {
                            $('#resultEdit').html('<div class="alert alert-danger" id="denger-alert" role="alert">La filière n\'a pas été modifier avec succès </div>');
        ...
        $(document).ready(function() {
            ...
            $('#saveEdit').click(function() {
                ...
                var id_filiere = $('#saveEdit').data('id');
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            if (dataResult.statusCode == 200) {
                                ...
                                $('#resultEdit').html('<div class="alert alert-danger" id="denger-alert" role="alert">La filière  n\'a pas été modifie avec succès </div>');
                                $("#denger-alert").fadeTo(2000, 500).slideUp(500, function() {
                                    $("#denger-alert").slideUp(500);
                                });
                            }
