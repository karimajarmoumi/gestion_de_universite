                                ...
                                <div class="card-body" style="color:black">
                                        ...
                                        <tbody class="w-100">
                                            ...
                                            if ($result) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo '<td>' . $row["date"] . '</td>';
                                                    echo '<td class="text-center"> <i  class="fa fa-edit " onclick="showEdit(' . $row["id_etudiant"] . ')" style="color:#009de8;cursor:pointer;font-size: 16px;"></i><i class="fa fa-trash" onclick="showRemove(' . $row["id_etudiant"] . ')" style="margin-left:15px;color:red;cursor:pointer;font-size: 16px;"></i></td>';
                                                    echo "</tr>";
                                                }
                                            }
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="ecoleModelLabel">Éditer étudiant</h5>
                                    ...
                                    <div class="modal fade" id="removeModel" tabindex="-1" aria-labelledby="removeModel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="removeModel">Supprimer étudiant</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    ...
                                                    <div>
                                                        <div class="alert alert-danger text-center" role="alert">
                                                            <h1>Voulez-vous supprimer définitivement cette étudiant?</h1>
                                                        </div>
    ...
    <script>
            ...
            $(document).ready(function() {
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (result != '') {
                            $('#editEtudiant').html(result);
                            $('#ecoleModel').modal('show');
                            $('#id_etudiant').val(id);
                            $('#saveEdit').attr('data-id', id)

                        } else if (dataResult.statusCode == 201) {
                            $('#resultEdit').html('<div class="alert alert-danger" id="denger-alert" role="alert">L\'étudiant n\'a pas été modifier avec succès </div>');
        ...
        $(document).ready(function() {
            ...
            $('#saveEdit').click(function() {
                ...
                var id_etudiant = $('#saveEdit').data('id');
                var ecole = $('#inputGroupSelect2').find(":selected").val();
                var departement = $('#inputGroupSelect3').find(":selected").val();
                ...
                if (ecole != '' && departement != '' && filiere != '' && cne != '') {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            if (dataResult.statusCode == 200) {
                                ...
                                $('#resultEdit').html('<div class="alert alert-danger" id="denger-alert" role="alert">L\'étudiant n\'a pas été ajoutée avec succès </div>');
                                $("#denger-alert").fadeTo(2000, 500).slideUp(500, function() {
                                    $("#denger-alert").slideUp(500);
                                });
                            }
            ...
            $('#remove').click(function() {
                $.ajax({
                    ...
                    type: "GET",
                    data: {
                        removeEtudiantID: $(this).data('id'),
                    },
                    success: function(result) {
                        if (result = 1) {
                            location.reload(true);
                        } else {
                            $('#resultRemove').html('<div class="alert alert-danger " id="denger-alert" role="alert">L\'étudiant n\'a pas été supprimée avec succès </div>');
                            $("#denger-alert").fadeTo(2000, 500).slideUp(500, function() {
                                $("#denger-alert").slideUp(500);
                            });
                        }
